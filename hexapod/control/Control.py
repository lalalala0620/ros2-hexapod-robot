...
class Control:
    def __init__(self):
        ...
        self.calibration_leg_point=self.readFromTxt('/home/spider/hexapod_ws/src/hexapod/hexapod/control/point')
    ...
    def run(self,data,Z=25,F=64):#example : data=['CMD_MOVE', '1', '0', '25', '10', '0']
        gait=data[1]
...
if __name__=='__main__':
    control = Control() #-75 75 160
    # print(control.postureBalance( 0, 0 , 50))
    # time.sleep(1) 
    # control.postureBalance(0, 0 , 0)
    # time.sleep(1) 
    control.posittion(0, 0 , 0)
    time.sleep(1) 
